...
if not FindNearest then
    game.Players.LocalPlayer:Kick("Script error when join,pls rejoin")
end
MucTieu = {}
MucTieu.old =
    hookfunction(
...
local txt="GPO Jude HUB"
if identifyexecutor()=="Krnl" then 
    txt="Jude Hub GPO (KRNL)"
end
local Window = CFAHub:CreateWindow("<font color=\"#4FC3F7\">JUDE Hub</font>", txt, true)

--CFAHub:AddNoti("JUDE Hub Premium", "UI Loaded!", 6)
function GetSword()
