...
local Config = { WindowName = "JudeHub.Cloud | "..temptable.version, Color = Color3.fromRGB(255, 184, 65), Keybind = Enum.KeyCode.Semicolon}
...
information:CreateLabel("Place version: "..game.PlaceVersion)
information:CreateLabel("Script by Jude")
information:CreateLabel("Special thanks to myself")
local gainedhoneylabel = information:CreateLabel("Gained Honey: 0")
information:CreateButton("Discord Invite", function() setclipboard("https://discord.gg/7xHXBxsW4k") end)
information:CreateButton("Donation", function() setclipboard("later") end)
