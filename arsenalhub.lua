...
local name="Jude Hub v8 - Undetected - "..identifyexecutor()..""
...
MiscTabMainSection:Textbox("Custom Chat Message","Jude Ware V8 On Top",function(x)
...
W:Button("Kaearxnn#3221- Owner",function()
    print("Button Pressed")
end)
W:Button("None - Helper",function()
    setclipboard("https://discord.gg/7xHXBxsW4k")
end)
W:Button("None - Co Owner",function()
    print("Button Pressed")
end)
W:Button("None - Helper/Slave",function()
    print("Button Pressed")
end)
